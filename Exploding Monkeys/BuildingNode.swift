...
class BuildingNode: SKSpriteNode {
    ...
    /*
     * Function Name: hitAtPoint
     * Parameters: point - the point where the building was hit.
     * Purpose: This method creates a hole where the building was hit and updates the
